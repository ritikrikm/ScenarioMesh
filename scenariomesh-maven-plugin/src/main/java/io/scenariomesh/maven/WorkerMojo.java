...
public final class WorkerMojo extends AbstractMojo {
    ...
    @Parameter(property = "scenariomesh.distributed.token") private String token;
    ...
    @Override public void execute() throws MojoExecutionException {
        try {
            ...
            childEnvironment.put("SCENARIOMESH_REMOTE_TOKEN", effectiveToken);
        ...
        } catch (MojoExecutionException exception) { throw exception; }
